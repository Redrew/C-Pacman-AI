...
****************************************************************/
// Modified function so ghosts always chase/run away from Pacman
void MoveGhostsSim(state_t* state) {
    ...
    for(a = 0; a < 4; a++) {
        ...
        c = 0;
        do {
            // Always assume that ghost chase pacman
            ...
            // Not valid to chase / run from pacman choose a random direction
            if (c != 1) {
